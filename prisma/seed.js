    ...
    if (index === 1) {
      await prisma.services.upsert({
        ...
        create: {
          ...
          description:
            "Durante o caminho você verá praias urbanas, a Ponte Newton Navarro e o encontro do Rio Potengi com o mar. A primeira parada será na Praia da Redinha, na qual você poderá adquirir o ingresso para visitar o Aquário de Natal.",
          city: "Natal",
          state: "RN",
    ...
    if (index === 2) {
      await prisma.services.upsert({
        ...
        create: {
          ...
          description:
            "Um excelente passeio de buggy pelas praias do litoral norte assistindo as belezas naturais e quase intocadas das praias entre Touros/RN e Zumbi/RN. Durante o passeio você terá oportunidade de fazer 5 paradas para fotos. Conhecer o",
          city: "Zumbi",
          state: "RN",
    ...
    if (index === 3) {
      await prisma.services.upsert({
        ...
        create: {
          ...
          description:
            "Duração do passeio de mais ou menos 3 horas. O bugueiro prontamente os buscará no hotel ou pousada no horário combinado. Nossa primeira parada será no chapadão da Pipa, com vista para a bela praia do amor e praia do moleque. Prosseguiremos",
          city: "Pipa",
          state: "RN",
    ...
    if (index === 4) {
      await prisma.services.upsert({
        ...
        create: {
          ...
          description:
            "Duração do passeio de mais ou menos 4 horas. O bugueiro prontamente os buscará no hotel ou pousada no horário combinado. Nossa primeira parada será no chapadão da Pipa, com vista para a bela praia do amor e praia do moleque. Prosseguiremos",
    ...
    if (index === 5) {
      await prisma.services.upsert({
        ...
        create: {
          ...
          description:
            "Duração do passeio de mais ou menos 5 horas. O bugueiro prontamente os buscará no hotel ou pousada no horário combinado. Nossa primeira parada será no chapadão da Pipa, com vista para a bela praia do amor e praia do moleque. Prosseguiremos",
          city: "Bahia Formosa",
          state: "RN",
    ...
    if (index === 6) {
      await prisma.services.upsert({
        ...
        create: {
          ...
          description:
            "Duração do passeio de mais ou menos 6 horas. O bugueiro prontamente os buscará no hotel ou pousada no horário combinado. Nossa primeira parada será no chapadão da Pipa, com vista para a bela praia do amor e praia do moleque. Prosseguiremos",
          city: "Sagi",
          state: "RN",
